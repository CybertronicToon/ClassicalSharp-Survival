...
namespace OpenTK.Graphics.OpenGL {
	...
	unsafe partial class GL {
		...
		} static IntPtr BlendFuncSeparateAddress;
		...
		public static void TexEnvf( TextureEnvTarget target, TextureEnvParameter pname, float param ) {
			Interop.Calli( (int)target, (int)pname, param, TexEnvfAddress);
		} static IntPtr TexEnvfAddress;
		
		public static void TexEnvfv( TextureEnvTarget target, TextureEnvParameter pname, float[] @params ) {
			unsafe {
				fixed (float* @params_ptr = @params) {
					Interop.Calli( (int)target, (int)pname, @params_ptr, TexEnvfvAddress);
				}
			}
		} static IntPtr TexEnvfvAddress;
		
		public static void TexEnvfv( TextureEnvTarget target, TextureEnvParameter pname, float* @params ) {
			Interop.Calli( (int)target, (int)pname, @params, TexEnvfvAddress);
		}
