...
namespace ClassicalSharp.GraphicsAPI {
	...
	public class Direct3D9Api : IGraphicsApi {
		...
		Blend srcBlendFuncAlpha = Blend.One;
		Blend dstBlendFuncAlpha = Blend.Zero;
		public override void AlphaBlendFunc(BlendFunc srcFunc, BlendFunc dstFunc) {
			...
			srcBlendFuncAlpha = blendFuncs[(int)BlendFunc.One];
			dstBlendFuncAlpha = blendFuncs[(int)BlendFunc.Zero];
