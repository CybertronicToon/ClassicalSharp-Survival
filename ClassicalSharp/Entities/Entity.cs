...
namespace ClassicalSharp.Entities {
	...
	public abstract class Entity {
		...
		public float HeadX, HeadY, RotX, RotY, RotZ, fallDistance;
		...
		public virtual void Damage(short damage) { }
		...
		public Matrix4 TransformMatrix(Vector3 scale, Vector3 pos) {
			...
			Quaternion rotQuat = Quaternion.ToQ(-RotY, -RotX, -RotZ);
